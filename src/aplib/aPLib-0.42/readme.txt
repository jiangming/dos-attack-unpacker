     ...
     Copyright (c) 1998-2004 by Joergen Ibsen / Jibz, All Rights Reserved
...
-----
 ...
 Please read the documentation file 'doc/aPLib-0.42.chm' or
 'doc/html/index.html'.
...
-------
 ...
 aPLib is free for non-commercial use (if nobody charges money for products
 that use it). If you use aPLib in a product, an acknowledgement would be
 ...
 Using aPLib in a commercial product requires registration -- please check
 the end of this file for more information.

 The definition of a product that _uses_ aPLib is a product that contains
 any part of aPLib EXCEPT the decompression code. So you can sell a product
 that uses data compressed with aPLib without registering, but NOT a product
 that contains any part of the compression code.
